...
app.initializers.add('davidnery/nickname-group-formatter', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PostUser__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'view', function (content) {
    ...
    var primaryGroup = user.groups().find(function (group) {
      return group.attribute('displayStyle') !== null;
    });
    ...
    var color = primaryGroup.attribute('color');
    var displayStyle = primaryGroup.attribute('displayStyle');
    this.$('.username').html(displayStyle.replace('{username}', user.displayName()).replace('{groupcolor}', color || '#FFF'));
  });
});
